...
- Follow `documentation/agent-workflow-definition.md` for long-running agent-assisted work, progress artifacts, handoff state, and work-role boundaries.
...
- long-running work conventions if the repo uses an external agent harness or unattended agent runs
